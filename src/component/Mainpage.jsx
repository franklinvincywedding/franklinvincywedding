      ...
      <div id="contentArea">
        ...
        <div className=' mt-3 '>
          ...
          <div className='bg-[#8162a2] p-2 rounded bgCardTexture font-semibold'>
            <p className='text-white text-center text-sm'>&#10084; WEDDING &#10084;</p>
            <p className='text-center text-white mt-2 text-sm font-semibold'>23-May-2025 @ 10:00 AM <br/> SA Church Thiruchendur</p>
            {/* <a className='text-right text-white block mt-2 text-xs ' href="http://www.google.com/calendar/event?action=TEMPLATE&text=Naveen+Priya+Wedding+Event&dates=20240608/20240608&details=NAVEEN%20PRIYA%20RECEPTION%0AYadava%20Krishna%20Mahal%0A279%2C%20Big%20Car%20St%2C%20Thiruparankundram%2C%20Tamil%20Nadu%20625005location=Yadava%20Krishna%20Mahal%0A279%2C%20Big%20Car%20St%2C%20Thiruparankundram%2C%20Tamil%20Nadu%20625005"> Add to calendar </a> */}
            </div>
          <div className='bg-[#8162a2] p-2 rounded bgCardTexture mt-3 font-semibold'>
            <p className='text-white text-center text-sm'>&#10084; RECEPTION &#10084;</p>
            <p className='text-center text-white mt-2 text-sm'>23-May-2025 @ 06:00 PM to 09:00 PM <br/> RK Mahal Erachakulam - Kanniyakumari</p>
            {/* <a className='text-right text-white block mt-2 text-xs ' href="http://www.google.com/calendar/event?action=TEMPLATE&text=Naveen+Priya+Wedding+Event&dates=20240609/20240609&details=NAVEEN%20PRIYA%20MARRIAGE%0AYadava%20Krishna%20Mahal%0A279%2C%20Big%20Car%20St%2C%20Thiruparankundram%2C%20Tamil%20Nadu%20625005location=Yadava%20Krishna%20Mahal%0A279%2C%20Big%20Car%20St%2C%20Thiruparankundram%2C%20Tamil%20Nadu%20625005"> Add to calendar </a> */}
            </div>
        </div>
        ...
        {/* <div className=' mt-3  '>
          ...
          <div className='flex justify-center gap-3 pt-3 '>
            <a target='_blank' className='bg-[#8162a2] hover:bg-[#9b72c6] w-24 text-white py-2 px-3 rounded-md flex flex-col gap-1 cursor-pointer justify-center items-center'>
...
-187 292 -345 328 -70 16 -1451 13 -1511 -4z"/>
        ...
        <div className=' mt-3 '>
          ...
          <p className='text-sm p-1 hover:bg-[#efeef0] '>Mobile: <a href='tel:+918870365100'>+91 8870365100</a></p>
      ...
      <p className='text-center text-black text-xs  font-medium mt-1'>&#x2764; &#x2764; Franklin & Vincy Catherine &#x2764; &#x2764;</p>
